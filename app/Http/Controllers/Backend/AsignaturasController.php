...
class AsignaturasController extends Controller {
	...
	public function store()
	{
		...
		$asignaturas->save();
		return redirect()->route('asignaturas.index')->with('message', '¡Agregado asignatura con éxito!');
	}
	...
	public function update($id)
	{
		...
		$asignaturas->departamento_id = \Request::input('departamento_id');
		$asignaturas->save();
		return redirect()->route('asignaturas.index')->with('message', '¡Se han realizado cambios con éxito!');
	}
	...
	public function destroy($id)
	{
		$asignaturas = \App\Models\Asignatura::find($id);
		$asignaturas->delete();
		return redirect()->route('asignaturas.index')->with('message', '¡Se ha eliminado asignatura con éxito!');
	}
