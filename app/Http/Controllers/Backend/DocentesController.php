...
class DocentesController extends Controller {
	...
	public function store()
	{
		...
		$docentes->save();
		return redirect()->route('docentes.index')->with('message', '¡Se ha agregado docente exitosamente!');
	}
	...
	public function update($id)
	{
		...
		$docentes->apellidos = \Request::input('apellidos');
		$docentes->save();
		return redirect()->route('docentes.edit', ['docente' => $id])->with('message', '¡Se ha guardado los cambios exitosamente!');
	}
	...
	public function destroy($id)
	{
		$docentes = \App\Models\Docente::find($id);
		$docentes->delete();
		return redirect()->route('docentes.index')->with('message', '¡Se ha eliminado docente exitosamente!');
	}
