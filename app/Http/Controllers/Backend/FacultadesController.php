...
class FacultadesController extends Controller {
	...
	public function store()
	{
		...
		$facultad->latitud = \Request::input('latitud');
		$facultad->descripcion = \Request::input('descripcion');
		$facultad->save();
		return redirect()->route('facultades.index')->with('message', '¡Se ha agregado la facultad exitosamente!');
	}
	...
	public function update($id)
	{
			...
			$facultad->descripcion = \Request::input('descripcion');
			$facultad->save();
			return redirect()->route('facultades.edit', ['facultad' => $id])->with('message', '¡Se han realizado los cambios con éxito! ');
	}
	...
	public function destroy($id)
	{
			$facultad = \App\Models\Facultad::find($id);
			$facultad->delete();
			return redirect()->route('facultades.index')->with('message', '¡Se ha eliminado facultad con éxito!');
	}
