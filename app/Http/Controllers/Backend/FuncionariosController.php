...
class FuncionariosController extends Controller {
	...
	public function store()
	{
		...
		$funcionarios->save();
		return redirect()->route('funcionarios.index')->with('message', '¡Se ha agregado Funcionario exitosamente!');
	}
	...
	public function update($id)
	{
		...
		$funcionarios->apellidos = \Request::input('apellidos');
		$funcionarios->save();
		return redirect()->route('funcionarios.edit', ['funcionario' => $id])->with('message', '¡Se han guardados los cambios exitosamente!');
	}
	...
	public function destroy($id)
	{
		$funcionarios = \App\Models\Funcionario::find($id);
		$funcionarios->delete();
		return redirect()->route('funcionarios.index')->with('message', '¡Se ha elimnado funcionario exitosamente!');
	}
