...
class HorariosController extends Controller {
			...
			public function store()
			{
				...
				$horario->save();
				return redirect()->route('horarios.index')->with('message', '¡Se ha agregado horario exitosamente!');
			}
			/**
			...
			public function show($id)
			{
				...
				$curso = \App\Models\Curso::find($horario->curso_id);
			...
			public function update($id)
			{
				...
				$horario->curso_id = \Request::input('curso_id');
				$horario->save();
				return redirect()->route('horarios.edit', ['horario' => $id])->with('message', '¡Se han hecho los cambios exitosamente!');
			}
			/**
			...
			public function destroy($id)
			{
				$horario = \App\Models\Horario::find($id);
				$horario->delete();
				return redirect()->route('horarios.index')->with('message', '¡Se ha eliminado horario exitosamente!');
			}
		}
