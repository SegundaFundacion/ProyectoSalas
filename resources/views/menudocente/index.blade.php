...
<br><br><br>
<div class="jumbotron">
        <p> <CENTER> <strong><h2>Bienvenido al menu del Docente<small><br>Seleccione una accion a realizar</small></h2></strong></CENTER> </p>
      </div>
          ...
          <section class="wrapper">
              <div class="row mt">
                  <div class="col-md-12">
                      ...
                      <center>
                          <a href="/periodos"  class="btn btn-lg btn-primary">Periodos</a>
